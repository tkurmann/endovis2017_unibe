...
#
python3 inference.py --inference_file="../../data_export/tf/binary_test_$instrument.tfrecords"  --output_folder="results/$instrument/test/" --models_folder="model/train/binary_3" --frame_start_number=0 --unet_layers=6 --unet_features_root=32 --unet_kernel=3 --data_augmentation_level=9 --unet_shortskip=True --seed=42 --resize_factor=0.3
...
#
python3 create_parts_set.py --split="test" --leaveout=$instrument --removeprobe=True --binary_results_folder="../src/binary_segmentation/results/$instrument/test/" --binary_results_start=0


cd ../src/instrument_part_segmentation

#python3 train.py --experiment="parts_$instrument" --unet_layers=6 --unet_features_root=32 --unet_kernel=3 --data_augmentation_level=9 --unet_shortskip=True  --training_file="../../data_export/tf/parts_train_$instrument.tfrecords" --eval_file="../../data_export/tf/parts_eval_$instrument.tfrecords" --max_steps=50000 --initial_learning_rate=1e-4 --resize_factor=0.3 --loss_type="dice"


python3 inference.py --inference_file="../../data_export/tf/parts_test_$instrument.tfrecords"  --output_folder="results/$instrument/test/" --models_folder="model/train/parts_3" --frame_start_number=0 --unet_layers=6 --unet_features_root=32 --unet_kernel=3 --data_augmentation_level=9 --unet_shortskip=True --seed=42 --resize_factor=0.3
...
python3 create_instrument_set.py --split="test" --leaveout=$instrument --removeprobe=True --binary_results_folder="../src/binary_segmentation/results/$instrument/test/" --binary_results_start=0


cd ../src/instrument_type_segmentation

python3 inference.py --inference_file="../../data_export/tf/type_test_$instrument.tfrecords"  --output_folder="results/$instrument/test/" --models_folder="model/train/type_3" --frame_start_number=0 --unet_layers=6 --unet_features_root=32 --unet_kernel=3 --data_augmentation_level=9 --unet_shortskip=True --seed=42 --resize_factor=0.3
