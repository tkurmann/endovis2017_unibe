...
def tower_loss(scope):
    ...
    logits = densenet.model(x=images, channels=FLAGS.num_channels, n_class=FLAGS.num_classes, layers=FLAGS.unet_layers, features_root=FLAGS.unet_features_root, keep_prob=0.5)
    print(logits.shape)
    ...
    _ = unet.loss(logits, labels, weights.astype(np.float32))
...
def train():
    ...
    with tf.Graph().as_default():
        ...
        logits = unet.model(x=images_placeholder, channels=FLAGS.num_channels, n_class=FLAGS.num_classes, layers=FLAGS.unet_layers, features_root=FLAGS.unet_features_root,filter_size=FLAGS.unet_kernel, training=bn_training_placeholder, keep_prob=keep_prob_training_placeholder)
        ...
        with tf.Session() as sess:
            ...
            for step in range(FLAGS.max_steps):
                    ...
                    train_feed = {images_placeholder: images_s,
                                    ...
                                    keep_prob_training_placeholder: 0.5}
