...
class InstrumentSet():
    ...
    def generate_binary_labels(self, instrument_parts, instrument_types):
        ...
        # print(gt_data.shape)
        return left_image_data,  part_gt_data
...
def main(unused_argv):
    ...
    labels = np.empty([0,IMAGE_HEIGHT,IMAGE_WIDTH, 4]).astype(np.uint8)
    ...
    convert_to(left_images, labels,binary_segmentations, "parts_"+FLAGS.split+"_"+str(leave_out))
